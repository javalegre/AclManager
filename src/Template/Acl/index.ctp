...
<div class="row panel">
    <div class="columns large-4">
        ...
        <ul class="options">
            ...
            <li>
                <?php echo $this->Html->link(__('Manage {0}', strtolower($item)), ['controller' => 'Acl', 'action' => 'Permissions', $item]); ?>
                <?php echo $this->Html->link('Exportar', ['controller' => 'Acl', 'action' => 'Exportar', $item]); ?>
            </li>
            <?php endforeach; ?>
        </ul>
    </div>
